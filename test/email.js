...
describe.only('email', function() {
  ...
  it("can add cc address")
  it("can add bcc address")

  it("can add multiple to addresses")
  it("can add multiple cc addresses")
  it("can add multiple bcc addresses")


  it("cannot send with no to addresses")
  it("can send email with valid subject")
  it("can send email with valid body")
